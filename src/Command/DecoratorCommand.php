...
use MonkeyCoders\Patterns\Structural\Decorator\Triangle;
use MonkeyCoders\Patterns\Structural\Decorator\BoderShape;
class DecoratorCommand extends Command
{
    protected function configure()
    {
        ...
        ->setName('MonkeyCoders:Decorator')
